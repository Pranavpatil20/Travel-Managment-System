    ...
    Choice c1;
      ...
      Signup() {
         ...
         p1.add(l4);
          ...
          c1 = new Choice();
         c1.add(" Fav Color");
         c1.add("Bahubali or KGF");
         c1.add("Lucky Number");
         c1.add(" Fav Cricket Player");
         ...
         p1.add(l5);
          ...
          t4 = new JTextField();
         t4.setBounds(190, 180, 150,25);
         t4.setBorder(BorderFactory.createEmptyBorder());
         p1.add(t4);
         
         ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/signup.png"));
         Image i2 = i1.getImage().getScaledInstance(250, 250, Image.SCALE_DEFAULT);
         ImageIcon i3 = new ImageIcon(i2);
         JLabel l6 = new JLabel(i3);
         l6.setBounds(480, 50, 250, 250);
         add(l6);
