...
public class customerReport extends JFrame implements ActionListener{
    ...
    customerReport(){
        ...
        JLabel l10 = new JLabel("Customer Details Report");
        ...
        l4.setBounds(360,50,70,20);
        add(l4);
        
         JLabel l5 = new JLabel("Gender");
        l5.setBounds(490,50,70,20);
        add(l5);
       
         JLabel l6 = new JLabel("Country");
        l6.setBounds(590,50,70,20);
        add(l6);
        
        JLabel l7 = new JLabel("Address");
        l7.setBounds(700,50,70,20);
        add(l7);
        
        
        JLabel l8 = new JLabel("Phone No");
        l8.setBounds(820,50,70,20);
        add(l8);
        
         JLabel l9 = new JLabel("Email");
        l9.setBounds(940,50,70,20);
        add(l9);
