...
//        setLocation(400, 200);
        ...
        p1.setBackground(new Color(131, 193, 233));  //131, 193, 233
        p1.setBounds(0, 0, 350, 390);
      
       
        add(p1);
        
       ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/loginp.jpg"));
       //Image i2 = i1.getImage().getScaledInstance(180, 150, Image.SCALE_DEFAULT);
       //ImageIcon i3 = new ImageIcon(i2);
        JLabel l1 = new JLabel(i1);
        l1.setBounds(100, 120, 200, 200);    //100, 120, 200, 200
        p1.add(l1);
        
       JPanel p2 = new JPanel(); 
        p2.setLayout(null);
	p2.setBounds(300, 15, 450, 310);
