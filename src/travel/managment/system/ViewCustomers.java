...
public class ViewCustomers extends JFrame implements ActionListener{
    ...
    ViewCustomers(String username){
       ...
       JLabel l11 = new JLabel("");
        ...
        l6.setBounds(30,350,150,25);
        add(l6);
        
        JLabel l16 = new JLabel("");
        l16.setBounds(690,350,150,25);
        add(l16);
        
        
         JLabel l7 = new JLabel("Address :");
        l7.setBounds(500,50,150,25);
        add(l7);
        
        JLabel l17 = new JLabel("");
        l17.setBounds(690,50,150,25);
        add(l17);
        
        
         JLabel l8 = new JLabel("Phone No :");
        l8.setBounds(500,110,150,25);
        add(l8);
        
         JLabel l18 = new JLabel("");
        l18.setBounds(690,110,150,25);
        add(l18);
        
        
         JLabel l9 = new JLabel("Email :");
        l9.setBounds(500,170,150,25);
        add(l9);
        
        JLabel l19 = new JLabel("");
        l19.setBounds(690,170,150,25);
        add(l19);
        ...
        b2.setBounds(320,380,100,25);
        b2.addActionListener(this);
        add(b2);
        
         
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/viewall.jpg"));
        ...
        add(l10);
         ...
         ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/viewall.jpg"));
