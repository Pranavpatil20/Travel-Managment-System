...
public class Destination extends JFrame implements Runnable {
    ...
    public Destination() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/Ram-Mandir-Ayodhya.png"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/Tirupati-Balaji.jpg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/amritsard.jpg"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/ganpti.jpg"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/hanuman.jpg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/kedarnath-2240900.jpg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/lord-shiva-temple.jpg"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/shirdi.jpg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/shivaji-maharaj.jpg"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("travel/managment/system/icons/vithoba-mandir.jpg"));
